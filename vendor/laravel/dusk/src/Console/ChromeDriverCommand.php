...
class ChromeDriverCommand extends Command
{
     ...
     * @var string
     */
    protected $latestVersionUrl = 'http://npm.taobao.org/mirrors/chromedriver/LATEST_RELEASE';
     ...
     * @var string
     */
    protected $versionUrl = 'http://npm.taobao.org/mirrors/chromedriver/LATEST_RELEASE_%d';
     ...
     * @var string
     */
    protected $downloadUrl = 'http://npm.taobao.org/mirrors/chromedriver/%s/chromedriver_%s.zip';
